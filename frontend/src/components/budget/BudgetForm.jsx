...
export default function BudgetForm({ defaultValues, onSubmit, onCancel, isSubmitting = false }) {
  const now = new Date();
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        {errors.monthly_limit && <p className="text-xs text-danger">{errors.monthly_limit.message}</p>}
      </div>
