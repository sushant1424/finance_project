...
const PLANS = [
  {
    ...
    features: [
      ...
      { text: 'Basic reports & charts', included: true },
  ...
  },
  {
    ...
    price: 'NPR 499',
    period: '/month',
    description: 'For power users who want deeper insights and unlimited flexibility.',
    highlighted: true,
    cta: 'Coming soon',
    href: ROUTES.REGISTER,
    features: [
      ...
      { text: 'Configurable EWMA analysis', included: true },
    ],
  },
];
      ...
      <div className="mx-auto max-w-6xl">
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-muted">
            Start free today. Pro features are coming soon — no payment required right now.
          </p>
        </div>
